...
class BrainAgent:
    ...
    def think_cycle(self) -> list[DailyInsight]:
        ...
        print(f"\n🔄 Think cycle at {now.strftime('%H:%M:%S')}")
        ...
        if testable:
            print(f"  🧪 Testing {len(testable)} hypotheses...")
...
"""
    ...
    def run_forever(self, cycle_interval_minutes: int = 60):
        ...
        """
        print(f"\n🧠 Brain entering continuous mode (cycle every {cycle_interval_minutes}m)")
